...
meth="WBS.launch(int, boolean, boolean, int, boolean, boolean, int, boolean, boolean)"
java -cp "build/main:lib/*" edu.utexas.gsoc.inv.instrument.AssertionSynthesis "$origjavafile" "$genjavafile" "daikon_invariants.txt" "$meth" $out

java -cp "build/main:lib/*" edu.utexas.gsoc.inv.instrument.AssertionSynthesis -jar lib/org.eclipse.jdt.core-3.7.1.jar "$origjavafile" "$genjavafile" "daikon_invariants.txt" "$meth" $out
